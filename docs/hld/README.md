...
The High-Level Design is partitioned into twelve modular chapters:
...
1. **Static Marker & Link Check:** CI validates all twelve `<!-- OpenSpec: TRD-HLD-xx -->` markers, cross-file document links, and ADR traceability citations.
